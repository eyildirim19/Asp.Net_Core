...
namespace _10_StateManagement_QueryString2.Entities
{
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<OgrenciNot> OgrenciNots { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OgrenciNot>(entity =>
            {
                entity.HasKey(e => e.NotId);

                entity.ToTable("OgrenciNot");

                entity.Property(e => e.NotId).ValueGeneratedNever();

                entity.Property(e => e.Not).HasColumnType("decimal(4, 2)");

                entity.Property(e => e.NotTur).HasMaxLength(50);

                entity.HasOne(d => d.Ogrenci)
                    .WithMany(p => p.OgrenciNots)
                    .HasForeignKey(d => d.OgrenciId)
                    .HasConstraintName("FK_OgrenciNot_Ogrenci");
            });
